...
<cms:template title='Ecografie'>

	<cms:editable name='echo_text'
       label="Ecografie Text"
       type="richtext">
					Ecografie text here
	</cms:editable>
	
	<cms:editable name='echo_summary'
		label="Echo Summary"
		type='text'>
		Some text here!
		</cms:editable>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-8 mbr-inner-padding text-xs-center mbr-table-cell-lg">
                        <h3 class="mbr-section-title display-4"><u>Echografie</u></h3>
                        <div class="lead">
                            <p><cms:show echo_summary /></p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-lg-4 mbr-table-cell-lg image-size" style="width: 50%;">
                        <div class="mbr-figure"><img src="<cms:show echo_image />" alt="Image will be displayed here"></div>
                    </div>
                </div>
            </div>
        </section>
