...
<cms:template title='PNE'>

	<cms:editable name='pne_text'
       label="PNE Text"
       type="richtext">
					PNE text here
	</cms:editable>
	
	<cms:editable name='pne_summary'
		label="PNE Summary"
		type='text'>
		Some text here!
		</cms:editable>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-8 mbr-inner-padding text-xs-center mbr-table-cell-lg">
                        <h3 class="mbr-section-title display-4"><u>PNE</u></h3>
                        <div class="lead">
                            <p><cms:show pne_summary /></p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-lg-4 mbr-table-cell-lg image-size" style="width: 50%;">
                        <div class="mbr-figure"><img src="<cms:show pne_image />" alt="Image will be displayed here"></div>
                    </div>
                </div>
            </div>
        </section>
