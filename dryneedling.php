   ...
   <section class="mbr-section mbr-after-navbar" id="content5-1i" data-rv-view="37" style="background-color: #eae9e1; padding-top: 0rem; padding-bottom: 3rem;">
      <div class="container">
         ...
         <div class="lead">
            ...
            <p>Met deze techniek ga ik op zoek naar spierverhardingen en verkortingen. Deze kunnen ontstaan door;</p>
            <ul>
               <li>trauma’s;</li>
               <li>langdurige verkeerde houding/belasting;</li>
               <li>langdurige stress en andere psychische aandoeningen;</li>
               <li>slaaptekort;</li>
               <li>chronische infecties;</li>
               <li>weinig beweging;</li>
               <li>psychologische factoren;</li>
               <li>voetafwijkingen of beenlengte verschillen;</li>
               <li>overbelasting bij sporters;</li>
               <li>en na lange tijd van immobiliteit.</li>
            </ul>
            <p>Gevolgen van teveel actieve triggerpoint kunnen klachten geven als;
            </p>
            <ul>
               <li>bewegingsbeperkingen;</li>
               <li>stijfheid;</li>
               <li>uitstralende pijn;</li>
               <li>pijnklachten en pijn ontwijkend gedrag;</li>
               <li>&nbsp;en zweten, duizeligheid, wazig zien en/of koude handen.</li>
            </ul>
            <p>De behandeling richt zich op het vrijmaken van deze spierblokkades. Er zal altijd in ketens (een groep van meerdere spieren) worden gekeken en niet alleen op de locatie van pijn. Als een klacht langer bestaat heeft dit ook gevolgen voor omliggende structuren.</p>
         </div>
         <h5 class="mbr-section-title display-5 text-xs-center"><u>Bijwerkingen</u></h5>
         <div class="lead">
            <p>De naald zelf tijdens het doorboren van de huid voelt u niet. Tijdens de behandeling kunt u een diep/dof gevoel hebben in en rondom de spier. Dit kan samengaan met uitstraling naar andere regio’s. Iedere spier heeft zijn uitstralingsgebieden, voor meer info bezoek deze website tussen haakjes voor een simpele en heldere verklaring <a href="https://www.eerstehulpwiki.nl/wiki/index.php/referred_pain">Referred Pain</a>. De nawerking kan heel verschillend zijn. Dit verschilt namelijk per spierregio. De meest voorkomende bijwerking is spierpijn. De duur van de spierpijn verschilt per persoon en klacht. In wat bijzondere gevallen zijn er mensen bekend die flauwvallen, duizelig worden, zweten en zeer veel moeheid na de behandeling. Vaak komt dit naar voren bij mensen die laag belastbaar zijn op de locatie waar behandeld wordt. Dit kan aardig in beeld worden gebracht door een goed intake gesprek.
            </p>
         </div>
         <h5 class="mbr-section-title display-5 text-xs-center"><u>Zin en onzin van de behandeling</u></h5>
         <div class="lead">
            <p>Het is een behandeling met mogelijkheden op het gebied van spieren/pezen/botten en gewrichten en de mechanica tussen deze structuren. De volgende metafoor zal hierbij een kleine illustratie geven.
            </p>
            <p>Zie voor u een tent die scheef wordt getrokken door twee van de acht scheerlijnen (spieren) die te strak staan. Hierdoor komt er meer druk te staan op de tentstokken (botten). Ook op de punten waar de tentstokken samen komen (gewrichten) is de druk groter. Door spanning van de scheerlijnen af te halen verdwijnt de druk.
            </p>
