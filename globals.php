<?php require_once( 'couch/cms.php' ); ?>
    <cms:template title='Global Settings' executable='0'>
        ...
        <cms:editable name='home_summary' label='Home Summary' height='50' type='richtext'>
            Heeft u lichamelijke klachten die niet goed uit zichzelf herstellen? Wij zoeken uit wat de klacht in stand houdt. Dit betekend een behandelplan voor u op maat.
        </cms:editable>
...
Phone:<br />
+31 (0)6-14475229 (Davey van Vliet)<br />
+31 (0)6-39731280 (Joally Jonker)</p>
        </cms:editable>
