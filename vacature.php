...
<cms:template title='Vacature'>

	<cms:editable name='vacature_text'
       label="Vacature Text"
       type="richtext">
					Vacature description here
	</cms:editable>
	
	<cms:editable name='vacature_summary'
		label="Vacature Summary"
		type='text'>
		Some text here!
		</cms:editable>
...
<cms:embed 'header.html' />
        ...
        <section class="mbr-section mbr-section-nopadding mbr-after-navbar" id="msg-box4-1k" data-rv-view="40" style="padding-top: 3rem; padding-bottom: 0rem;">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-lg-12 mbr-inner-padding text-xs-center">
                        <h3 class="mbr-section-title display-4"><u>Vacature</u></h3>
                        <div class="lead">
                            <p><cms:show vacature_summary /></p>
                        </div>
                    </div>
                </div>
            </div>
