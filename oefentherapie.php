...
<cms:template title='Oefentherapie'>

	<cms:editable name='oefen_text'
       label="Oefentherapie Text"
       type="richtext">
					Oefentherapie text here
	</cms:editable>
	
	<cms:editable name='oefen_summary'
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-8 mbr-inner-padding text-xs-center mbr-table-cell-lg">
                        <h3 class="mbr-section-title display-4"><u>Oefentherapie</u></h3>
                        <div class="lead">
                            <p><cms:show oefen_summary /></p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-lg-4 mbr-table-cell-lg image-size" style="width: 50%;">
                        <div class="mbr-figure"><img src="<cms:show oefen_image />" alt="Image will be displayed here"></div>
                    </div>
                </div>
            </div>
        </section>
