...
<cms:template title='Corona'>

	<cms:editable name='corona_text'
       label="Corona Text"
       type="richtext">
					Corona description here
	</cms:editable>
	
	<cms:editable name='corona_summary'
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-lg-12 mbr-inner-padding text-xs-center">
                        <h3 class="mbr-section-title display-4"><u>Corona Updates</u></h3>
                        <div class="lead">
                            <p><cms:show corona_summary /></p>
                        </div>
                    </div>
                </div>
            </div>
