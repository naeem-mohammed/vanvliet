...
<cms:template title='Praktijk kat Floki'>
<cms:editable name='about_us_text'
       label="About Us Text"
       type="richtext">
					Text about Praktijk kat Floki
	</cms:editable>
...
<head>
  ...
  <title>Praktijk kat Floki</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-8 mbr-inner-padding text-xs-center mbr-table-cell-lg">
                        <h3 class="mbr-section-title display-4"><u>Praktijk kat Floki</u></h3>
                        <div class="lead">
